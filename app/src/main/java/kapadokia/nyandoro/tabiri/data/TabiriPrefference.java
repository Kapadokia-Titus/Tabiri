package kapadokia.nyandoro.tabiri.data;

import android.content.Context;

public class TabiriPrefference {
     ...
     */
    public static final String PREF_COOD_LAT = "coord_lat";
    public static final String PREF_COOD_LONG = "coord_long";
    ...
    public static final String DEFAULT_WEATHER_LOCATION  = "80100, KENYA";
